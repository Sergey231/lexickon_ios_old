...
internal enum Localized {
  /// Войти
  internal static let loginLoginButtonTitle = Localized.tr("Localizable", "Login_login_button_title")
  /// У меня есть аккаунт
  internal static let loginScreenTitle = Localized.tr("Localizable", "Login_screen_title")
  /// Повторите пароль
